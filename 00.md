...
继续 [CS50G](https://github.com/csfive/CS50G) 的学习。
...
```lua
-- class.lua 源码，来自 https://github.com/vrld/hump/blob/master/class.lua

-- 深拷贝 + 不覆盖
-- 编译时 mixin，不是运行时顺着原型链查找
-- 子类的方法优先级更高，会覆盖父类的方法
...
AI 的解释如下，但是我看不懂 lua 这块的语法，这个之后探究吧。
